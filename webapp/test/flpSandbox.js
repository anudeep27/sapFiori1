		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comanudeepproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comanudeepproject2-display": {
								"semanticObject": "comanudeepproject2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.anudeep.project2",
									"url": sap.ui.require.toUrl("com/anudeep/project2")
								}
							}
						}
					}
